...
-- Here we are assuming that the parquet files are present in /partition/year=2024/*/*/
CREATE EXTERNAL TABLE TripExtTable
WITH (
	LOCATION = '/partition/year=2024/*/*/*.parquet',
...
FROM 
    OPENROWSET(BULK '/partition/year=2024/*/*/*.parquet', FORMAT='PARQUET')
